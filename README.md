...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0wgn4qy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0wgn4qy.containers.anotherwebservice.com/
...
```
git clone git@github.com:Minosuko/container-0wgn4qy.git
cd container-0wgn4qy
```
...
```
docker attach container-0wgn4qy
```
